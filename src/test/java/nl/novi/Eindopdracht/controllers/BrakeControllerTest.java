...
/*
    ...
    void getAllBrakes() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("car/find/all"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0].id").value(1L))
                .andExpect(jsonPath("$[0].partName").value("Brake Part"))
                .andExpect(jsonPath("$[0].partNumber").value("123456"))
                .andExpect(jsonPath("$[0].price").value(9.99))
                .andExpect(jsonPath("$[0].amountOfParts").value(1))
                .andExpect(jsonPath("$[0].outerDiameter").value(10.5))
                .andExpect(jsonPath("$[0].centerDiameter").value(5.5))
                .andExpect(jsonPath("$[0].boreTypeNumberOfHoles").value("Type A, 4 holes"))
                .andExpect(jsonPath("$[0].wheelStudDiameter").value(6.0))
                .andExpect(jsonPath("$[0].withoutWheelMountingBolts").value(false))
                .andExpect(jsonPath("$[0]. withoutWheelHub").value(true))

                .andExpect(jsonPath("$[1].id").value(2L))
                .andExpect(jsonPath("$[1].partName").value("Brake Part2"))
                .andExpect(jsonPath("$[1].partNumber").value("789012"))
                .andExpect(jsonPath("$[1].price").value(14.99))
                .andExpect(jsonPath("$[1].amountOfParts").value(2))
                .andExpect(jsonPath("$[1].outerDiameter").value(11.0))
                .andExpect(jsonPath("$[1].centerDiameter").value(6.0))
                .andExpect(jsonPath("$[1].boreTypeNumberOfHoles").value( "Type B, 5 holes"))
                .andExpect(jsonPath("$[1].wheelStudDiameter").value(6.5))
                .andExpect(jsonPath("$[1].withoutWheelMountingBolts").value(true))
                .andExpect(jsonPath("$[1]. withoutWheelHub").value(false))

                .andExpect(jsonPath("$[2].id").value(3L))
                .andExpect(jsonPath("$[2].partName").value("Brake Part 3"))
                .andExpect(jsonPath("$[2].partNumber").value("345678"))
                .andExpect(jsonPath("$[2].price").value(19.99))
                .andExpect(jsonPath("$[2].amountOfParts").value(1))
                .andExpect(jsonPath("$[2].outerDiameter").value(10.0))
                .andExpect(jsonPath("$[2].centerDiameter").value(5.0))
                .andExpect(jsonPath("$[2].boreTypeNumberOfHoles").value("Type C, 6 holes"))
                .andExpect(jsonPath("$[2].wheelStudDiameter").value(6.2))
                .andExpect(jsonPath("$[2].withoutWheelMountingBolts").value(false))
                .andExpect(jsonPath("$[2]. withoutWheelHub").value(true));
    }
